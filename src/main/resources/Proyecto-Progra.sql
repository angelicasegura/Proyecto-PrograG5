...
(4,1, 'Desobrante', 'Desodorante vegano, con olor a coco. Es 100% vegano y amigable con el ambiente',5900, 15,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7y1r6zZ777cypYQhGHsL63XVCNj3hwnsUoQ&s'),
...
SELECT User, Host FROM mysql.user WHERE User = 'usuario_proyecto';

create table mas_Vendidos (
	id_mas_Vendidos INT NOT NULL AUTO_INCREMENT,
    id_producto INT NOT NULL, 
    ruta_imagen varchar(1024),
    PRIMARY KEY (id_mas_Vendidos),
...
INSERT INTO mas_Vendidos (id_mas_Vendidos, id_producto, ruta_imagen)VALUES
